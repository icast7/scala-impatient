...
//
//
// 5. Provide operators that construct an HTML table. For example, Click here to view code image Table() | "Java" | "Scala" | | "Gosling" | "Odersky" | | "JVM" | "JVM, .NET" should produce Click here to view code image < table > < tr > < td > Java </ td > < td > Scala </ td > </ tr > < tr > < td > Gosling...
//
